#ifndef _CTB_RIPEMD160_H
#define _CTB_RIPEMD160_H
...
#ifdef CTB_RIPEMD160_IMPLEMENTATION
...
void ctb_ripemd160_init(ctb_ripemd160_ctx *ctx)
{
    memzero(ctx, sizeof(ctb_ripemd160_ctx));
    ctx->total[0] = 0;
    ctx->total[1] = 0;
